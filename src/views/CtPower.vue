...
const refreshData = async () => {
  ...
  try {
    ...
    const dataCarnot = await fetchCarnotData('ctPower', [startTime, _endTime])
    chartData1.value = dataCarnot as ChartDataRow[]

    const dataMega = settingsStore.getMegaData('ctPower', [startTime, _endTime])
