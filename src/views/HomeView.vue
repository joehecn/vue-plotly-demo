...
const handleFromCsvChange = (value: boolean) => {
...
<template>
  ...
  <div>
    <h2>配置数据来源</h2>
    <el-switch v-model="fromCsv" style="--el-switch-on-color: #ff4949; --el-switch-off-color: #13ce66"
      active-text="从 CSV 文件" inactive-text="从 AI 策略" @change="handleFromCsvChange" />
  </div>

  <FromCsv v-if="fromCsv" @change="refreshTable" />

  <ChillerStrategy v-else @change="refreshTable" />
