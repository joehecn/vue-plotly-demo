...
const refreshData = async () => {
  ...
  try {
    ...
    const dataCarnot = await fetchCarnotData('cdwpPower', [startTime, _endTime])
    chartData1.value = dataCarnot as ChartDataRow[]

    const dataMega = settingsStore.getMegaData('cdwpPower', [startTime, _endTime])
